...
Widget makeLineI(String needText, IconData img, void Function() onPressDo){
  return             Container(
              height: 42,
              margin: EdgeInsets.only(left: 16,right: 16),
              child: ElevatedButton(
                ...
                child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 24,
                        margin: EdgeInsets.only(left: 8),
                        child: Icon(img, color: AppColors.primary),
                      ),
                      const SizedBox(
                        width: 12,
                      ),
                      ...
                      Container(
                        ...
                        height: 24,
                        margin: EdgeInsets.only(right: 8),
                        child: Icon(Icons.keyboard_arrow_right, color: AppColors.textDark,)
                      ),
                    ]),
              ),
            );
